...
interface EditQuizComponentProps {
  quizId: string
}

export default function EditQuizComponent({ quizId }: EditQuizComponentProps) {
    ...
    const fetchQuiz = async () => {
      try {
        ...
        const transformedQuestions = quizData.questions.map((q: any) => ({
          ...
          question: q.question,
          options: q.options,
          correctAnswer: q.type === 'multiple-choice-multiple' && q.correct_answer 
